...
urlpatterns = i18n_patterns(
    ...
    path("management/", site_views.settings, name="settings"),
    path("management_list/", site_views.management_list, name="management_list"),
    path("new_contact_task/", site_views.new_contact_task, name="new_contact_task"),
